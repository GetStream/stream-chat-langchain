...
export class Agent {
  ...
  private aiAgent?: LangChainAIAgent;
  ...
  async start(): Promise<void> {
    ...
    try {
      ...
      this.aiAgent = new LangChainAIAgent(
        this.chatClient,
        channel,
        this.platform,
        this.serverTools,
  ...
  static async generateSummary(
    ...
    const rawSummary = extractTextFromMessage(response);
...
const extractTextFromMessage = (message: AIMessage): string => {
  if (!message) {
    return '';
  }
